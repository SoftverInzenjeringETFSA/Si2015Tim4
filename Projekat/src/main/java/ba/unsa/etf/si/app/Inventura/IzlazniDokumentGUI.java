...
public class IzlazniDokumentGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IzlazniDokumentGUI window = new IzlazniDokumentGUI();
	...
	private void initialize() {
		...
		final JLabel lblDokument = new JLabel("Novi izlazni dokument");
